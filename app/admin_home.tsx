    ...
    <View style={styles.container}>
      ...
      <View style={styles.featuresContainer}>
        <TouchableOpacity style={styles.featureButton}>
          <FontAwesome5 name="file-signature" size={40} color="white" />
        ...
        <TouchableOpacity style={styles.featureButton}>
          <FontAwesome5 name="tachometer-alt" size={40} color="white" />
...
const styles = StyleSheet.create({
  ...
  headerLine: { width: '100%', height: 4, backgroundColor: 'yellow', position: 'absolute', top: 70 },
  ...
  featuresContainer: { flexDirection: 'row', justifyContent: 'space-between', width: '95%', marginTop: 20, marginBottom: 340 },
  featureButton: { alignItems: 'center', flex: 1, padding: 15, backgroundColor: '#1a3ab5', borderRadius: 20, marginHorizontal: 10 },
  featureText: { marginTop: 5, fontSize: 16, fontWeight: 'bold', color: 'white', textAlign: 'center' },
